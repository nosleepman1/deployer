...
echo "============================================================="
echo "   Preparation de l'environnement AMBO Tech Deployer"
echo "============================================================="

# 1. Mise a jour minimale et paquets indispensables
...
if [ -d "$DEPLOYER_DIR" ]; then
  echo "Mise a jour du CLI Deployer..."
  cd "$DEPLOYER_DIR"
...
# 4. Installation des dependances et compilation
echo "Installation des dependances et compilation TypeScript..."
npm install --loglevel=error
npm run build

# 5. Creation du lien symbolique global 'deployer'
sudo ln -sf "$DEPLOYER_DIR/bin/deployer.js" /usr/local/bin/deployer
sudo chmod +x /usr/local/bin/deployer

echo "============================================================="
echo "AMBO Deployer est pret ! Lancement de l'assistant..."
echo "============================================================="
